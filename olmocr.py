...
PDF_PATH = "books/shamail-31-40.pdf"
...
# Prompts
SYSTEM_PROMPT = """You are a highly accurate document OCR AI. Your sole job is to extract text from the provided document page EXACTLY as it appears, while strictly following all the instructions."""

USER_PROMPT = """Attached is an image of one page of a document. Return the plain text representation of this document as if you were reading it naturally. Convert equations to LateX and tables to HTML.
        ...
        for attempt in range(MAX_RETRIES):
            try:
                ...
                async with session.post(API_URL, headers=headers, json=payload) as response:
                    ...
                    # --- NEW: Fallback to fix hallucinated JSON keys ---
